...
public class TreeUtil {
	...
	/*
	 * Riempie pila.pop restituisce figli in ordine)
	 */
	public static <E> void childrenStack(Tree<E> subtree, Stack<Tree<E>> pila) {
		childrenStackAux(subtree.getFirstSubtree(), pila);
	}

	private static <E> void childrenStackAux(Tree<E> subtree, Stack<Tree<E>> pila) {
		if (subtree == null)
			return;
		childrenStackAux(subtree.getNextSiblingSubtree(), pila);
		pila.push(subtree);
	}
	...
	public static <E> void printPreorder(Tree<E> t) {
		...
		for (Tree<E> subtree = t.getFirstSubtree(); subtree != null; subtree = subtree.getNextSiblingSubtree()) {
