...
public class Labirinto {
	...
	private boolean uscitaRaggiungibileDa(int r, int c){
		...
		marcata[r][c] = true; // marca la cella come già esplorata nel percorso attuale
		if (uscita(r, c))
			return true;
		...
		marcata[r][c] = false; // la cella non si è rivelata utile al raggiungimento dell'uscita
		return false;
    }
    ...
    public String toString() {
		...
		//descrizione[descrizione.length-1] = ' ';
...
public class Labirinto {
	...
	private boolean uscitaRaggiungibileDa(int r, int c){
		...
		marcata[r][c] = true; // marca la cella come gi�� esplorata nel percorso attuale
		if (uscita(r, c))
			return true;
		...
		marcata[r][c] = false; // la cella non si � rivelata utile al raggiungimento dell'uscita
		return false;
    }
